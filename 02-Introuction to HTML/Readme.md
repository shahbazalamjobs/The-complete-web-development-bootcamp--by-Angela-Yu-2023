...
* Also here in name attribute we write yourName, yourEmail, yourMessage which specifies the name of the input field, which is used to identify the field in the form data sent to the server. <br>
