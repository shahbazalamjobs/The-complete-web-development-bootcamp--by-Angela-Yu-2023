...
2. Class selector: 
   ...
   - The above code will make all the tags with class name "my-class" blue color and center align same classes (here "my-class")  `<h1 class="my-class">` and `<p class="my-class">`
